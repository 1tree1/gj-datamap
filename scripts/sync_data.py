...
FILES = {
    ...
    # 2026-09-21 진입 관문 (pipeline/build_arrival_transport.py)
    "processed/gateways_4326.geojson":          "gateways.geojson",
    "processed/visitor_origin_sigg_4326.geojson": "visitor_origin.geojson",
}
DST.mkdir(exist_ok=True)
# 비공간 표(사이드바용)
for s_, d_ in {"raw/visitors_gyeongju_daily.json": "visitors.json", "processed/arrival_transport.json": "arrival_transport.json", "processed/traffic_hourly.json": "traffic_hourly.json", "processed/traffic_congested.json": "traffic_congested.json", "processed/traffic_hist_summary.json": "traffic_hist_summary.json", "raw/kosis_nationality_gj.json": "nationality.json", "processed/youth_city.json": "youth.json", "processed/report_map_stats.json": "map_stats.json", "processed/web_extras.json": "web_extras.json", "processed/report_stats.json": "report_stats.json", "processed/hwango_report.json": "hwango_report.json", "processed/visitor_origin_summary.json": "visitor_origin_summary.json", "processed/arts_stats.json": "arts_stats.json"}.items():
